...
export default function ResetPasswordPage() {
  ...
  if (hasSession === null) {
    return <main className="mx-auto max-w-sm px-4 py-10 text-sm text-zinc-600">Ładowanie…</main>;
  }

  if (!hasSession) {
    return (
      <main className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-sm flex-col justify-center px-4">
        <h1 className="mb-2 text-xl font-semibold text-zinc-50">Link wygasł</h1>
  ...
  if (done) {
    return (
      <main className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-sm flex-col justify-center px-4">
        <h1 className="mb-2 text-xl font-semibold text-zinc-50">Gotowe</h1>
        <p className="text-sm text-zinc-400">Hasło zmienione. Przenosimy Cię na stronę główną…</p>
      </main>
    );
  }
  ...
  return (
    <main className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-sm flex-col justify-center px-4">
      <h1 className="mb-1 text-xl font-semibold text-zinc-50">Ustaw nowe hasło</h1>
      <p className="mb-8 text-sm text-zinc-500">Ostatni krok.</p>
